...
import com.cj.mobile.myarapplication.MultiDexApplication;
import com.cj.mobile.myarapplication.OnGetImageListener;
...
//                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
    ...
    public static void openCamera(final int width, final int height) {
        ...
        try {
            ...
            if (ActivityCompat.checkSelfPermission(MultiDexApplication.getContext(),
